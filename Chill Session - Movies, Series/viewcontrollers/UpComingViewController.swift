...
class UpComingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        CellRegisterHelper.registerCellForCollectionView(nibName: "MovieCollectionViewCell", cellId: "MovieCollectionViewCell", collectionView: upComingCollectionView)
        
        CustomLoadingView.shared().showActivityIndicator(uiView: self.upComingCollectionView)
    ...
    func loadMovie() {
        ...
        DataModel.shared().getMovies(context: managedObjectContext,route: SharedConstants.Route.UPCOMING, success: { (movieList) in
